...
TWA Revivalの公開問い合わせ窓口です。daraskが個人で運営しています。
...
不具合や遊び方について、Issuesから連絡できます。閲覧は誰でもできます。投稿にはGitHubアカウントが必要です。日本語・英語・ロシア語で投稿できます。

**投稿内容は公開されます。** パスワード、認証コード、セッショントークン、メールアドレス、アカウントID、未加工のログを記載しないでください。画像にも個人情報が写っていないか確認してください。

アカウント情報の確認・修正・削除については、最初は「アカウントについて相談したい」とだけ記載してください。本人確認と削除の運用は一般公開に向けて整備中です。公開投稿やプレイヤーネームだけでは本人確認は完了せず、Epicアカウント自体の削除は扱いません。
